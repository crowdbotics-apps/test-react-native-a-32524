...
## Project Structure
    ...
    ├── test_react_native_a_32524  # Django project configurations
...
1. Clone this repo and `cd test_react_native_a_32524`
...
2. Clone this repo and `cd test_react_native_a_32524`
